...
// node_modules/react-increment-number/lib/index.mjs
...
function lr() {
  return Oe || (Oe = 1, function() {
    ...
    var xe = false, je = false, ke = false, Fe = false, De = false, ee;
...
` + a[c].replace(" at new ", " at ");
        ...
        G = false, B.current = u, $e(), Error.prepareStackTrace = i;
      }
    ...
    function Le(e, r, t, n, i) {
      {
        ...
        for (var o in e)
          if (u(e, o)) {
            ...
            a && !(a instanceof Error) && (U(i), m("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", n || "React class", t, o, typeof a), U(null)), a instanceof Error && !(a.message in le) && (le[a.message] = true, U(i), m("Failed %s type: %s", t, a.message), U(null));
          }
      }
    }
    ...
    function ze(e, r) {
      if (typeof e.ref == "string" && I.current && r && I.current.stateNode !== r) {
        ...
        K[t] || (m('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', S(I.current.type), e.ref), K[t] = true);
      }
    }
    function Ke(e, r) {
      {
        var t = function() {
          me || (me = true, m("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r));
        };
    ...
    function He(e, r) {
      {
        var t = function() {
          he || (he = true, m("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r));
        };
...
(function(v) {
  false ? v.exports = cr() : v.exports = lr();
})(Q);
var dr = Q.exports.Fragment;
var vr = Q.exports.jsx;
var Ce = (v, _) => {
  if (typeof v == "number")
    return v;
  if (isNaN(Number(v)))
...
var mr = (v) => {
  const {
    to: _,
    callback: j
  } = v, [E, w] = (0, import_react.useState)(0), P = (0, import_react.useRef)(0);
  let y = null;
  const R = (s) => {
...
react-increment-number/lib/index.mjs:
  (**
   * @license React
...
react-increment-number/lib/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=react-increment-number.js.map
